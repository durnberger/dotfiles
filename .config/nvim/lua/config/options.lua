...
--opt.colorcolumn = '80'              -- Vertical line marking textwidth                    
...
opt.spelllang = 'en_gb'             -- Use British English
...
--opt.textwidth = 80                  -- Number of typed characters before a line break
